       ...
       <div class="row">
           ...
           <div class="col-8 col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 layout-spacing">
               <form class="border px-4 pt-2 pb-3" method="POST" action=" " enctype="multipart/form-data">
                   ...
                   <div class="form-group">
                     <label class="form-label" for="basic-addon-name">User Name</label>
                     <input type="text" id="basic-addon-name" class="form-control" placeholder="Name" name="name" value="{{$users->username}}"aria-label="Name" aria-describedby="basic-addon-name" disabled/>
                     @error('username')
                     <span class="text-danger">{{$message}}</span>
                     @enderror
                   </div>
